...
from users.models.user import User, users
from users.schemas.user import UserCreate, User as sch_user
...
def get_user_by_email(db: Session, email: str):  # sync
...
# def create_user(db: Session, user: UserCreate):  # sync
...
async def create_user(user: UserCreate):
    ...
    return sch_user(**user.dict(), id=user_id)
